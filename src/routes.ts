...
import { CreateRecipeByIngredientNameController } from "./controller/CreateRecipeByIngredientNameController"
...
routes.post("/recipe/name", new CreateRecipeByIngredientNameController().handle)
